document.addEventListener("DOMContentLoaded", () => {
  ...
  let clickedProDescription = document.getElementById(
    "clicked-pro-description"
  );
  // go back
                  ...
                  product.find((p) => {
                    if (p.id == productID) {
                      ...
                      localStorage.setItem(
                        "cart",
                        JSON.stringify(productListArray)
                      );

                      // Send a signal to update the cart dynamically
                      window.dispatchEvent(new Event("cartUpdated"));
                      console.log(productListArray);

                      //   let savedItem = JSON.parse(
                      //     localStorage.getItem("productListArray")
                      //   );
